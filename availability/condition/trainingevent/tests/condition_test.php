...
class condition_test extends \advanced_testcase {
    ...
    public function test_usage() {
        $this->markTestSkipped('IOMAD availability_trainingevent condition_test is a broken group->company find-replace copy (calls non-existent create_company/create_companying); needs a rewrite against the IOMAD company API.');
