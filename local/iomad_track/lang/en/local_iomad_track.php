...
$string['missingcoursename'] = 'A course name, course ID, or course code is required.';
$string['missingtimecompleted'] = 'A time completed value is required.';
$string['missingusername'] = 'A username or user ID is required.';
$string['importuser'] = 'Import completion information for a user';
